...
*/
        ...
        public:
            Basic_Constraints *copy() const override { return new Basic_Constraints(m_is_ca, m_path_limit); }
...
*/
        ...
        private:
            ...
            bool should_encode() const override { return (m_constraints != NO_CONSTRAINTS); }
...
*/
        ...
        public:
            ...
            Subject_Key_ID *copy() const override { return new Subject_Key_ID(m_key_id); }
...
*/
        ...
        public:
            Authority_Key_ID *copy() const override { return new Authority_Key_ID(m_key_id); }
...
*/
        ...
        public:
            ...
            Subject_Alternative_Name *copy() const override { return new Subject_Alternative_Name(get_alt_name()); }
...
*/
        ...
        public:
            ...
            Issuer_Alternative_Name *copy() const override { return new Issuer_Alternative_Name(get_alt_name()); }
...
*/
        ...
        public:
            Extended_Key_Usage *copy() const override { return new Extended_Key_Usage(m_oids); }
...
*/
        ...
        public:
            Name_Constraints *copy() const override { return new Name_Constraints(m_name_constraints); }
...
*/
        ...
        public:
            Certificate_Policies *copy() const override { return new Certificate_Policies(m_oids); }
...
*/
        ...
        public:
            CRL_ReasonCode *copy() const override { return new CRL_ReasonCode(m_reason); }
...
*/
        ...
        public:
            ...
            explicit CRL_Issuing_Distribution_Point(
                    const CRL_Distribution_Points::Distribution_Point &distribution_point) :
...
*/
        ...
        public:
            ...
            Unknown_Extension *copy() const override { return new Unknown_Extension(m_oid, m_critical); }
