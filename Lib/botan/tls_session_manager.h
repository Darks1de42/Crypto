...
*/
        ...
        public:
            bool load_from_session_id(const std::vector<uint8_t> &, Session &) override { return false; }

            bool load_from_server_info(const Server_Information &, Session &) override { return false; }
            ...
            std::chrono::seconds session_lifetime() const override { return std::chrono::seconds(0); }
        };
...
*/
        ...
        public:
            ...
            */
            ...
            std::chrono::seconds session_lifetime() const override { return m_session_lifetime; }
