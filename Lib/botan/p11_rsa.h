...
/// Represents a PKCS#11 RSA private key
        ...
        public:
            ...
            */
            PKCS11_RSA_PrivateKey(Session &session, uint32_t bits,
...
*/
        BOTAN_PUBLIC_API(2, 0) PKCS11_RSA_KeyPair
        generate_rsa_keypair(Session &session, const RSA_PublicKeyGenerationProperties &pub_props,
